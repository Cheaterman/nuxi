...
import { d as defineCommand, L, C } from '../shared/nuxi.b4d08588.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
...
function _resolveListenOptions(nuxtOptions, args) {
  ...
  const _socket = args.socket ?? process.env.NUXT_SOCKET ?? process.env.NITRO_SOCKET ?? process.env.SOCKET ?? nuxtOptions.devServer.socket ?? void 0;
